...
$$('[data-modal]').forEach(b=>b.onclick=e=>{e.preventDefault();e.stopPropagation();hideAccountDirect();openModal(b.dataset.modal)});
...
(async()=>{await loadProducts();applySeason(current);updateCartCount();updateAccount();try{if('serviceWorker'in navigator)navigator.serviceWorker.register('./sw.js?v=44').catch(()=>{})}catch(_){}})();
})();
