const CACHE='iroom-v39-notice-admin-history';
const CORE=['./','./index.html','./manifest.webmanifest','./iroom_assets/iroom-v39.css','./iroom_assets/iroom-v39.js','./iroom_assets/iroom-logo-final.png','./iroom_assets/app-icon-192.png','./iroom_assets/app-icon-512.png'];
