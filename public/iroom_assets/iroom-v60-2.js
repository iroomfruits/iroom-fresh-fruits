...
let publicSite={representative:'한효철',phone:'070-7762-3651',email:'iroom4562@naver.com',address:'서울특별시 송파구 송이로 15길 33',shippingFee:4000,freeShippingFrom:50000,jejuShippingExtra:4000,remoteShippingExtra:5000,courier:''};
let publicPolicies={
...
(async()=>{if(previewMode)document.body.classList.add('admin-preview-mode');await Promise.all([loadProducts(),loadHomepageConfig()]);applySeason(current);updateCartCount();updateAccount();try{if(!previewMode&&'serviceWorker'in navigator)navigator.serviceWorker.register('./sw.js?v=60').catch(()=>{})}catch(_){}})();
})();
