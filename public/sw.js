const CACHE='iroom-v34-commerce-editorial';
const CORE=['./','./index.html','./manifest.webmanifest','./iroom_assets/iroom-v34.css','./iroom_assets/iroom-v34.js','./iroom_assets/iroom-logo-final.png','./iroom_assets/app-icon-192.png','./iroom_assets/app-icon-512.png'];
