(()=>{
  ...
  if(document.body.classList.contains('home2-mode')){
    const adaptHome2=()=>{const t=$('[data-premium-title]'),p=$('[data-premium-copy]'),b=$('[data-premium-button]'),e=$('.premium-section .eyebrow');if(t)t.textContent='지금 가장 맛있는 과일';if(p)p.textContent='계절의 맛을 가장 좋은 순간에, 이룸이 엄선한 과일로 만나보세요.';if(b)b.textContent='전체보기';if(e)e.textContent='SEASON VIEW'};
