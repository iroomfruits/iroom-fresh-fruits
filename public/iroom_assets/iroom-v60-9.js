...
const INSTALL_DISMISS_KEY='iroom_pwa_install_collapsed_at_v60_9';
const INSTALL_CONFIRMED_KEY='iroom_pwa_installed_confirmed_v60_9';
const installButtons=()=>$$('[data-install-label]');
const installPrimary=()=> $('.app-install-banner-hotspot[data-install]');
