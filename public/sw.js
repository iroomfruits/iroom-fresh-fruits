const CACHE='iroom-v31-myiroom-label-clean';
const ASSETS=['./','./index.html','./iroom_assets/iroom-v30.css','./iroom_assets/iroom-v30.js','./iroom_assets/iroom-logo-final.png','./manifest.webmanifest'];
