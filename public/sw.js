const CACHE='iroom-v42-hover-pause-slider';
const CORE=['./','./index.html','./manifest.webmanifest','./iroom_assets/iroom-v42.css','./iroom_assets/iroom-v42.js','./iroom_assets/iroom-logo-final.png','./iroom_assets/app-icon-192.png','./iroom_assets/app-icon-512.png'];
