...
const seasons={
 spring:{label:'봄',heroCopy:'봄의 싱그러움을 가장 좋은 상태로 골라 산뜻하게 전합니다.',hero:['딸기','참외','청포도','토마토','체리'],heroImg:[null,null,null,'hero_elements/spring_tomato.png',null],today:[['금실딸기','국내 산지','당일 선별'],['성주참외','경북 성주','입고 상태 확인'],['대저토마토','부산 대저','당일 상태 확인'],['샤인머스캣','국내 산지','당일 상태 확인'],['체리','미국·뉴질랜드 등','당일 선별'],['망고','태국·페루 등','숙도 확인'],['자몽','미국·이스라엘 등','입고 상태 확인'],['아보카도','멕시코·페루 등','숙도 확인'],['블루베리','국내·칠레·페루 등','당일 선별'],['오렌지','미국·호주 등','입고 상태 확인']],premium:['금실딸기','성주참외','대저토마토','샤인머스캣','망고','체리','자몽','아보카도'],premiumImg:['premium_editorial/spring_01_strawberry.jpg','premium_editorial/spring_02_korean_melon.jpg','premium_editorial/spring_03_tomato.jpg','premium_editorial/spring_04_shine.jpg',null,null,null,null],seasonal:['사과','배','청포도','키위','파인애플','블루베리','오렌지','레몬'],library:['홍로사과','나주배','샤인머스캣','대봉','석류','제주감귤','키위','자몽','포도','블랙베리','망고','아보카도'],curation:'feature_art/spring_curation.jpg',gift:'feature_art/spring_gift.jpg'},
 summer:{label:'여름',heroCopy:'햇살이 더 달콤하게 만든 여름 과일을 시원하고 풍성하게 골라드립니다.',hero:['수박','복숭아','샤인머스캣','자두','멜론'],today:[['백도복숭아','국내 산지','숙도 확인'],['고당도수박','국내 산지','당일 선별'],['샤인머스캣','국내 산지','입고 상태 확인'],['머스크멜론','국내 산지','숙도 확인'],['자두','국내 산지','당일 상태 확인'],['망고','태국·페루 등','숙도 확인'],['체리','미국·뉴질랜드 등','당일 선별'],['파인애플','필리핀·코스타리카 등','숙도 확인'],['용과','베트남 등','입고 상태 확인'],['리치','태국·중국 등','당일 선별']],premium:['백도복숭아','고당도수박','머스크멜론','샤인머스캣','망고','체리','파인애플','용과'],premiumImg:['premium_editorial/summer_01_peach.jpg','premium_editorial/summer_02_watermelon.jpg','premium_editorial/summer_04_melon.jpg','premium_editorial/summer_03_shine.jpg',null,null,null,null],seasonal:['자두','포도','블루베리','키위','리치','패션후르츠','망고스틴','바나나'],library:['블루베리','파인애플','망고','자몽','체리','멜론','포도','키위','석류','샤인머스캣','용과','리치'],curation:'feature_art/summer_curation.jpg',gift:'feature_art/summer_gift.jpg'},
 autumn:{label:'가을',heroCopy:'깊어가는 계절이 전하는 가장 특별한 맛을 오늘의 상태로 골라드립니다.',hero:['홍로사과','나주배','샤인머스캣','대봉','석류'],today:[['홍로사과','경북 청송 등','당일 선별'],['나주배','전남 나주','입고 상태 확인'],['샤인머스캣','국내 산지','당일 상태 확인'],['대봉','경남·전남 산지','후숙 상태 확인'],['석류','입고별 안내','당일 선별'],['망고','태국·페루 등','숙도 확인'],['자몽','미국·이스라엘 등','입고 상태 확인'],['아보카도','멕시코·페루 등','숙도 확인'],['망고스틴','태국 등','입고 상태 확인'],['패션후르츠','베트남 등','당일 선별']],premium:['홍로사과','나주배','샤인머스캣','대봉','석류','망고','자몽','아보카도'],premiumImg:['premium_editorial/autumn_01_apple.jpg','premium_editorial/autumn_02_pear.jpg','premium_editorial/autumn_03_shine.jpg','premium_editorial/autumn_04_persimmon.jpg',null,null,null,null],seasonal:['포도','밤','블랙베리','키위','파인애플','용과','망고스틴','패션후르츠'],library:['석류','포도','블랙베리','자몽','샤인머스캣','사과','배','키위','블루베리','제주감귤','망고','아보카도'],curation:'feature_art/autumn_curation.jpg',gift:'feature_art/autumn_gift.jpg'},
 winter:{label:'겨울',heroCopy:'차가운 계절에 더 빛나는 자연의 달콤함을 신선하게 골라 전합니다.',hero:['제주감귤','부사사과','금실딸기','한라봉','키위'],today:[['제주감귤','제주','당일 입고 확인'],['한라봉','제주','숙도 확인'],['금실딸기','국내 산지','당일 선별'],['부사사과','국내 산지','입고 상태 확인'],['나주배','전남 나주','입고 상태 확인'],['키위','국내·뉴질랜드 등','숙도 확인'],['자몽','미국·이스라엘 등','입고 상태 확인'],['블루베리','국내·칠레·페루 등','당일 선별'],['오렌지','미국·호주 등','입고 상태 확인'],['망고','태국·페루 등','숙도 확인']],premium:['제주감귤','한라봉','금실딸기','부사사과','나주배','샤인머스캣','키위','체리'],premiumImg:['premium_editorial/winter_01_mandarin.jpg','premium_editorial/winter_02_hallabong.jpg','premium_editorial/winter_03_strawberry.jpg','premium_editorial/winter_04_apple.jpg',null,null,null,null],seasonal:['금귤','자몽','블루베리','레몬','오렌지','바나나','아보카도','망고'],library:['키위','금귤','배','블루베리','자몽','제주감귤','사과','딸기','한라봉','석류','오렌지','레몬'],curation:'feature_art/winter_curation.jpg',gift:'feature_art/winter_gift.jpg'}
};
...
function productCard(name,img,premium=false,index=0){const m=meta(name),p=productFor(name),v=img||m[0];const base=alias[name]||name;const badge=premium?`<span class="badge ${imported.has(base)?'imported-badge':''}">${imported.has(base)?'수입 프리미엄':'국산 프리미엄'}</span>`:'';const signature=premium?`<span class="premium-card-no">IROOM ${String(index+1).padStart(2,'0')}</span>`:'';return `<article class="product-card commerce-card clickable-product ${premium?'premium-signature-card':''}" data-card-fruit="${esc(name)}" data-card-visual="${esc(v)}">${signature}${badge}<div class="image-wrap"><img src="${A+v}" alt="${esc(name)}"></div><h3>${esc(name)}</h3><p>${m[1]}</p><div class="mini-sale"><span>${esc(p.unit||'구성 상담')}</span><b>${displayPrice(p)}</b></div>${commerceButtons(name,v,true)}</article>`}
...
(async()=>{await loadProducts();applySeason(current);updateCartCount();updateAccount();try{if('serviceWorker'in navigator)navigator.serviceWorker.register('./sw.js?v=47').catch(()=>{})}catch(_){}})();
})();
