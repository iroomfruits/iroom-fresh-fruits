...
const INSTALL_DISMISS_KEY='iroom_pwa_install_collapsed_at_v60_10';
const INSTALL_CONFIRMED_KEY='iroom_pwa_installed_confirmed_v60_10';
const installButtons=()=>$$('[data-install-label]');
const installPrimary=()=> $('.app-install-strip-button[data-install]');
